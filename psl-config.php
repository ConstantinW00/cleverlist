 ...
 */
define("HOST", "rdbms.strato.de");			// The host you want to connect to. 
define("USER", "U3559541"); 			// The database username. 
define("PASSWORD", "ujaskbas77623490"); 	// The database password. 
define("DATABASE", "DB3559541");		// The database name.
